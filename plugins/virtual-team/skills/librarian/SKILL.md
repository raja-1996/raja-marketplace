...
**Role:** Librarian
**Action:** <full-index | partial-index | refresh | root-index>
**Summary:** <1-2 sentences: what was indexed and how many folders/files were covered>

### Details
- Folders indexed: <N>
- Files cataloged: <N>
- CLAUDE.md files created/updated: <N>
- Folders skipped: <list with reasons>

### Outcome
- <Notable patterns or conventions discovered>
- <Any gotchas or surprises found during indexing>
...
- Keep entries concise — another role should understand what was indexed
