...
**Role:** Security
**Action:** <security-review | vulnerability-assessment | threat-modeling | audit>
**Summary:** <1-2 sentences: what was reviewed and the security posture>

### Details
- <Areas reviewed (auth, input, data, API, infrastructure)>
- <Vulnerabilities found with severity (critical / high / medium / low)>
- <Checklist items passed vs failed>

### Outcome
- <Security verdict: pass / fail / conditional-pass>
