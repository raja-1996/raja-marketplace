...
**Role:** Explorer
**Action:** <codebase-mapping | feature-tracing | dependency-mapping | pattern-discovery>
**Summary:** <1-2 sentences: what was explored and the key findings>

### Details
- <Areas of codebase mapped>
- <Architectural pattern identified>
- <Key conventions discovered>
- <Dependencies traced>

### Outcome
- <Codebase map or feature trace>
- <Conventions and patterns documented>
