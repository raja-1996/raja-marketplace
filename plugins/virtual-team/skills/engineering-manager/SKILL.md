...
**Action:** <sprint-planning | task-breakdown | sequencing | dependency-mapping>
**Summary:** <1-2 sentences: what was planned and how work was organized>

### Details
- <Number of sprints created>
- <Total tasks broken down>
- <Key dependencies identified>
- <Critical path defined>

### Outcome
- <Sprint goals and task list>
